      ...
      <div className="checkout-container">
        ...
        {bookingParams && (
          <div className="search-details">
            <div className="search-params-display">
              ...
              <p>
                <strong>Destination:</strong> {bookingParams.hotel.hotelAddress}
              </p>
              <p>
                <strong>Guests:</strong> {bookingParams.guests}
              </p>
              <p>
                <strong>Dates:</strong>{" "}
                {formatDates(bookingParams.dateRange[0])}
              </p>
            </div>
          </div>
        )}
        <form onSubmit={handleCheckout}>
          ...
          <p className="warning-text">
            This is a test website, don't add your real card details.
          </p>
          <label>
            Expiry Date:
            <input
