                ...
                <ul className="destinations">
                    <li className="destination">
                        ...
                        <a onClick={handleNavigateToOslo} href="#!">
                            <img src="http://localhost:8080/api/get/image/Oslo.jpg" alt="Oslo" />
                            <h2>Oslo</h2>
                            <p>Norge</p>
                        </a>
                    </li>
                    <li className="destination">
                        ...
                        <a onClick={handleNavigateToÅlesund} href="#!">
                            <img src="http://localhost:8080/api/get/image/Ålesund.jpg" alt="Ålesund" />
                            <h2>Ålesund</h2>
                            <p>Norge</p>
                        </a>
                    </li>
                    <li className="destination">
                        ...
                        <a onClick={handleNavigateToAmsterdam} href="#!">
                            <img src="http://localhost:8080/api/get/image/Amsterdam.png" alt="Amsterdam" />
                            <h2>Amsterdam</h2>
                            <p>Norge</p>
                        </a>
                    </li>
